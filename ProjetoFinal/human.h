...
float P1D_ref[] = {0.609648, -4.297810, 0.000000};
float P1E_ref[] = {-0.606574, -4.297810, 0.000000};
float P2D_ref[] = {0.522193, -6.688396, 0.000000};
float P2E_ref[] = {-0.519119, -6.688396, 0.000000};
